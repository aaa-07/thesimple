      ...
      <div className="flex justify-center">
        <div>
          ...
          <div className="flex">
            ...
            <div>
              <div className="font-22 font-bold">Interface</div>
              <div className="font-14 mb-4 gray-7">Design</div>
        ...
        <div className="footer-white-container pl-8 pr-14 py-7 black-2 ml-52">
          ...
          <div className="mb-7 text-xs w-36">
            We help in crafting your idea to innovation
          </div>
          <div className="font-20 font-extrabold flex">
          ...
          <div className="mb-7 text-xs w-48">
            Ideal for product based companies (MNC and Startup’s)
          </div>
          <div className="font-20 font-extrabold flex">
            <div>Project</div>
            <Image
      ...
      <div className="mt-24 flex justify-center">
          ...
          <div className="flex">
            <div className="w-44">
              <div className="font-18 mb-4">
                Beginners Product design course
              </div>
        ...
        <div className="ml-20">
          <div className="w-44">
            ...
            <div className="font-18 mb-4">
              Improve user engagement or adoption
            </div>
            ...
            <div className="font-18 mb-4">
              Improve a Service or product&apos;s KPIs with UX
            </div>
          </div>
        </div>
        <div className="ml-20 black-3 footer-container-2 px-8 pb-10 flex flex-col">
          ...
          <div className="flex mb-6">
            ...
            <div className="font-24 font-medium ml-5">hey@thesimple.design</div>
          </div>
          <div className="flex">
            <Image
